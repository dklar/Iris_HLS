...
void norm_fix(uint8_t *image_in,uint8_t *image_out, int x, int y, int r1,int r2) {
	...
	for (int theta = 0; theta < 360; theta+=2) {
		...
		temp1 = (ap_ufixed<16,9>) (x + r1 * tempCos);//max: 320 + 120*1 = 440 -> 9 bit int
		temp2 = (ap_ufixed<16,9>) (x + r2 * tempCos);
		temp3 = (ap_ufixed<16,9>) (y + r1 * tempSin);
		temp4 = (ap_ufixed<16,9>) (y + r2 * tempSin);
